        ...
        <>
            ...
            rounded-b-[35px] px-3 md:px-20 py-4">
                ...
                <button
                    ...
                    >
                        <svg className='fill-white group-hover:fill-black hover:fill-black transition-colors duration-100 ease-out w-6 h-6' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 30 30">
