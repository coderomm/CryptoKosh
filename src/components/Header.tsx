        ...
        <>
            ...
            rounded-b-[35px] px-3 md:px-20 py-4">
                ...
                <div className="flex items-center justify-end">
                    <button
                        className="flex items-center justify-center gap-2 text-base bg-custom-gradient hover:bg-custom-gradient-none text-white hover:bg-white hover:fill-black hover:text-black rounded-full py-2 px-[18px]  transition-colors duration-100 ease-out"
                        onClick={handleRedirect}
                    >
                        <svg className='fill-white hover:fill-black transition-colors duration-100 ease-out w-6 h-6' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 30 30">
